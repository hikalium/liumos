...
struct EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL {
  ...
  uint64_t (*query_mode)(EFISimpleTextOutputProtocol *, wchar_t *,
...
struct EFI_RUNTIME_SERVICES {
  ...
  uint64_t _buf_rs4[3];
  uint64_t _buf_rs5;
  void (*reset_system)(EFIResetType, uint64_t reset_status, uint64_t data_size,
                       void *);
};
...
struct EFI_BOOT_SERVICES {
  ...
  uint64_t _buf2[2];
  uint64_t _buf3[2];
  uint64_t (*GetMemoryMap)(uint64_t *memory_map_size, EFIMemoryDescriptor *,
  ...
  uint64_t (*CreateEvent)(unsigned int Type, uint64_t NotifyTpl,
  ...
  uint64_t (*WaitForEvent)(uint64_t NumberOfEvents, void **Event,
                           uint64_t *Index);
  uint64_t _buf4_2[3];
  uint64_t _buf5[9];
  uint64_t (*LoadImage)(unsigned char BootPolicy, void *ParentImageHandle,
                        EFIDevicePathProtocol *, void *SourceBuffer,
                        uint64_t SourceSize, void **ImageHandle);
  uint64_t (*StartImage)(void *ImageHandle, uint64_t *ExitDataSize,
                         unsigned short **ExitData);
  uint64_t _buf6[2];
  uint64_t (*ExitBootServices)(void *ImageHandle, uint64_t MapKey);
  uint64_t _buf7[2];
  uint64_t (*SetWatchdogTimer)(uint64_t Timeout, uint64_t WatchdogCode,
                               uint64_t DataSize, unsigned short *WatchdogData);
  uint64_t _buf8[2];
  uint64_t (*OpenProtocol)(void *Handle, EFIGUID *Protocol, void **Interface,
                           void *AgentHandle, void *ControllerHandle,
                           unsigned int Attributes);
  uint64_t _buf9[2];
  uint64_t _buf10[2];
  uint64_t (*LocateProtocol)(EFIGUID *Protocol, void *Registration,
                             void **Interface);
  uint64_t _buf10_2[2];
  uint64_t _buf11;
...
struct EFI_FILE_PROTOCOL {
  ...
  uint64_t (*Open)(struct EFI_FILE_PROTOCOL *This,
                   ...
                   unsigned short *FileName, uint64_t OpenMode,
                   uint64_t Attributes);
  uint64_t (*Close)(struct EFI_FILE_PROTOCOL *This);
  uint64_t _buf2;
  uint64_t (*Read)(struct EFI_FILE_PROTOCOL *This, uint64_t *BufferSize,
                   void *Buffer);
  uint64_t (*Write)(struct EFI_FILE_PROTOCOL *This, uint64_t *BufferSize,
                    void *Buffer);
  uint64_t _buf3[2];
  uint64_t (*GetInfo)(struct EFI_FILE_PROTOCOL *This, EFIGUID *InformationType,
...
struct EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL {
  ...
  uint64_t (*UnregisterKeyNotify)(
      struct EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL *This, void *NotificationHandle);
};
